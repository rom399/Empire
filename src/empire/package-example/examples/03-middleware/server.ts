/**
 * 03 - Middleware (package-example mirror)
 *
 * Same as Empire's examples/03-middleware, but importing from the
 ...
 *
 * Run: npx tsx examples/03-middleware/server.ts   (from package-example/)
 * Open: http://localhost:9003
 */

import process from "process";
import { Empire, createLoggerMiddleware, Middleware } from "empire-ts";
